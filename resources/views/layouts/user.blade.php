...
<body>
	<div class="wrapper">
		<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">TextingApp</span>
        </a>
              ...
              <i class="align-middle" data-feather="sliders"></i> <span class="align-middle">Pagrindinis</span>
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="{{route('user.conv')}}">
              <i class="align-middle" data-feather="message-square"></i> <span class="align-middle">Pokalbiai</span>
            </a>
					</li>
				</ul>
		...
		<div class="main">
          ...
          <i class="hamburger align-self-center"></i>
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0" aria-labelledby="alertsDropdown">
								...
								<div class="dropdown-menu-footer">
									<a href="#" class="text-muted">Rodyti visus pranešimus</a>
								</div>
							</div>
						</li>
						<li class="nav-item dropdown">
                ...
                <img src="{{ asset('adminkit/static/img/avatars/avatar-4.jpg') }}" class="avatar img-fluid rounded me-1" alt="Charles Hall" /> <span class="text-dark">{{ Auth::user()->firstName}}</span>
              </a>
							<div class="dropdown-menu dropdown-menu-end">
								<a class="dropdown-item" href="{{route('user.profile')}}"><i class="align-middle me-1" data-feather="user"></i> Paskyros nustatymai</a>
