            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="firstName" class="col-md-4 col-form-label text-md-end">Vardas</label>
                        ...
                        <div class="row mb-3">
                            <label for="lastName" class="col-md-4 col-form-label text-md-end">Pavardė</label>
                        ...
                        <div class="row mb-3">
                            <label for="password" class="col-md-4 col-form-label text-md-end">Slaptažodis</label>
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-end">Patvirtinti slaptažodį</label>
